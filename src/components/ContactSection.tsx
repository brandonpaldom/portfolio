...
const contactItems: ContactItem[] = [
  { icon: emailIcon, url: 'mailto:brandonpaldom@gmail.com' },
  { icon: linkedinIcon, url: 'https://www.linkedin.com/in/brandonpaldom' },
  { icon: githubIcon, url: 'https://github.com/brandonpaldom' },
]

export default function ContactSection() {
  return (
    <section className="card flex flex-wrap justify-center gap-2">
      {contactItems.map(({ icon, url }) => (
        <ContactLink key={url} url={url} icon={icon} />
      ))}
    </section>
  )
}
